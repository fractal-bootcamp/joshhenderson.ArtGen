...
function ArtRender({ title, description, background }: { title: string, description: string, background: string }): JSX.Element {
    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center justify-center h-screen">
                <ArtRender key="2" title={title} description={description} background={background} />
            </div>
        </>
    );
}